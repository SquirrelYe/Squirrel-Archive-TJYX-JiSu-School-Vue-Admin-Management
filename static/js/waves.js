    ...
    return (function (e, t, r, a) {
      ...
      function u(e, t) {
        ...
        return (
          g.isString(e)
            ? v.Easings[e] || (r = !1)
            : (r = g.isArray(e) && 1 === e.length ? s.apply(null, e) : g.isArray(e) && 2 === e.length ? b.apply(null, e.concat([t])) : g.isArray(e) && 4 === e.length ? l.apply(null, e) : !1),
              ...
              for (var R in h) {
                ...
                if (i(n).isSVG || 'tween' === I || x.Names.prefixCheck(I)[1] !== !1 || x.Normalizations.registered[I] !== a) {
                  ...
                  if (
                    ...
                    (z = parseFloat(z) || 0),
                    '%' === G &&
                      (/^(fontSize|lineHeight)$/.test(R) ? ((z /= 100), (G = 'em')) : /^scale/.test(R) ? ((z /= 100), (G = '')) : /(Red|Green|Blue)$/i.test(R) && ((z = (z / 100) * 255), (G = ''))),
                    /[\/*]/.test(X))
                  )
                    G = D;
                  else if (D !== G && 0 !== M)
...
!(function (a, b, c, d) {
  ...
  function eb(a, b) {
    var c = b.center,
      ...
      e = a.prevDelta || {},
      f = a.prevInput || {};
    (b.eventType === O || f.eventType === Q) && ((e = a.prevDelta = { x: f.deltaX || 0, y: f.deltaY || 0 }), (d = a.offsetDelta = { x: c.x, y: c.y })),
  ...
  (Yb.prototype = {
    ...
    recognize: function (a) {
      ...
      return r(this.options.enable, [this, b])
        ? (this.state & (Vb | Wb | Xb) && (this.state = Rb), (this.state = this.process(b)), this.state & (Sb | Tb | Ub | Wb) && this.tryEmit(b), void 0)
    ...
    p(bc, ac, {
      ...
      directionTest: function (a) {
        ...
        return (
          e & b.direction ||
            (b.direction & X ? ((e = 0 === f ? S : 0 > f ? T : U), (c = f != this.pX), (d = Math.abs(a.deltaX))) : ((e = 0 === g ? S : 0 > g ? V : W), (c = g != this.pY), (d = Math.abs(a.deltaY)))),
          (a.direction = e),
