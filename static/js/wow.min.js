    ...
    (this.WOW = (function () {
      ...
      return (
        ...
        (d.prototype.init = function () {
          var a;
          return (
            (this.element = window.document.documentElement), 'interactive' === (a = document.readyState) || 'complete' === a ? this.start() : document.addEventListener('DOMContentLoaded', this.start)
          );
        }),
        ...
        (d.prototype.stop = function () {
          return (
            window.removeEventListener('scroll', this.scrollHandler, !1), window.removeEventListener('resize', this.scrollHandler, !1), null != this.interval ? clearInterval(this.interval) : void 0
          );
        }),
