...
(function (t, i, n, e) {
  "use strict";
  var r, o, s, a, h, l, c, u, p, d, f, m, w, y, g, b, v, x, S, P, C, N, k, H, T, A, M, j = [].indexOf || function (t) {
    for (var i = 0, n = this.length; n > i; i++)
      if (i in this && this[i] === t) return i;
    return -1
  };
  C = "notify", P = C + "js", s = C + "!blank", k = {
    t: "top",
    m: "middle",
    b: "bottom",
    l: "left",
    ...
    }), e.css && (r += "/* styles for " + e.name + " */\n" + e.css), r && (e.cssElem = b(r), e.cssElem.attr("id", "notify-" + e.name)), s = {}, o = n(e.html), p("html", o, s), p("text", o, s), e.fields = s
  }, b = function (t) {
    var i;
    ...
    function t(t, i, e) {
      "string" == typeof e && (e = {
        className: e
      }), this.options = g(N, n.isPlainObject(e) ? e : {}), this.loadHTML(), this.wrapper = n(a.html), this.options.clickToHide && this.wrapper.addClass("" + P + "-hidable"), this.wrapper.data(P, this), this.arrow = this.wrapper.find("." + P + "-arrow"), this.container = this.wrapper.find("." + P + "-container"), this.container.append(this.userContainer), t && t.length && (this.elementType = t.attr("type"), this.originalElement = t, this.elem = d(t), this.elem.data(P, this), this.elem.before(this.wrapper)), this.container.hide(), this.run(i)
    }
    return t.prototype.loadHTML = function () {
      ...
      var t, i, e, r, o, s, a, l;
      return l = this.getPosition(), a = l[0], s = l[1], o = k[a], t = k[s], r = a + "|" + s, i = m[r], i || (i = m[r] = h("div"), e = {}, e[o] = 0, "middle" === t ? e.top = "45%" : "center" === t ? e.left = "45%" : e[t] = 0, i.css(e).addClass("" + P + "-corner"), n("body").append(i)), i.prepend(this.wrapper)
    }, t.prototype.setElementPosition = function () {
      var t, i, r, o, s, a, h, l, c, u, p, d, f, m, g, b, S, P, C, N, T, A, z, D, E, L, O, I, W;
      for (z = this.getPosition(), N = z[0], P = z[1], C = z[2], p = this.elem.position(), l = this.elem.outerHeight(), d = this.elem.outerWidth(), c = this.elem.innerHeight(), u = this.elem.innerWidth(), D = this.wrapper.position(), s = this.container.height(), a = this.container.width(), m = k[N], b = x[N], S = k[b], h = {}, h[S] = "b" === N ? l : "r" === N ? d : 0, y(h, "top", p.top - D.top), y(h, "left", p.left - D.left), W = ["top", "left"], E = 0, O = W.length; O > E; E++) T = W[E], g = parseInt(this.elem.css("margin-" + T), 10), g && y(h, T, g);
      if (f = Math.max(0, this.options.gap - (this.options.arrowShow ? r : 0)), y(h, S, f), this.options.arrowShow) {
        for (r = this.options.arrowSize, i = n.extend({}, h), t = this.userContainer.css("border-color") || this.userContainer.css("background-color") || "white", L = 0, I = v.length; I > L; L++) T = v[L], A = k[T], T !== b && (o = A === m ? t : "transparent", i["border-" + A] = "" + r + "px solid " + o);
        y(h, k[b], r), j.call(v, P) >= 0 && y(i, k[P], 2 * r)
      } else this.arrow.hide();
      return j.call(M, N) >= 0 ? (y(h, "left", H(P, a, d)), i && y(i, "left", H(P, r, u))) : j.call(w, N) >= 0 && (y(h, "top", H(P, s, l)), i && y(i, "top", H(P, r, c))), this.container.is(":visible") && (h.display = "block"), this.container.removeAttr("style").css(h), i ? this.arrow.removeAttr("style").css(i) : e
    }, t.prototype.getPosition = function () {
      var t, i, n, e, r, o, s, a;
      if (i = this.options.position || (this.elem ? this.options.elementPosition : this.options.globalPosition), t = S(i), 0 === t.length && (t[0] = "b"), n = t[0], 0 > j.call(v, n)) throw "Must be one of [" + v + "]";
      return (1 === t.length || (e = t[0], j.call(M, e) >= 0 && (r = t[1], 0 > j.call(w, r))) || (o = t[0], j.call(w, o) >= 0 && (s = t[1], 0 > j.call(M, s)))) && (t[1] = (a = t[0], j.call(w, a) >= 0 ? "m" : "l")), 2 === t.length && (t[2] = t[1]), t
      ...
      if (this.container || t) {
        ...
        for (a in o) r = o[a], h = this.userFields[a], h && ("text" === h && (r = c(r), this.options.breakNewLines && (r = r.replace(/\n/g, "<br/>"))), l = a === s ? "" : "=" + a, u(this.userContainer, "[data-notify-" + h + l + "]").html(r));
    ...
    return b(a.css).attr("id", "core-notify"), n(i).on("click", "." + P + "-hidable", function () {
