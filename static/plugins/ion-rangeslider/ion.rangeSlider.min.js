          ...
          if (this.old_from !== this.result.from || this.old_to !== this.result.to || this.force_redraw || this.is_key) {
            ...
            if ('single' === this.options.type)
              (this.$cache.s_single[0].style.left = this.coords.p_single + '%'),
                ...
                this.options.values.length
                  ? (this.$cache.input.prop('value', this.result.from_value), this.$cache.input.data('from', this.result.from_value))
                  : (this.$cache.input.prop('value', this.result.from), this.$cache.input.data('from', this.result.from));
            else {
              ...
              this.options.values.length
                ...
                : (this.$cache.input.prop('value', this.result.from + ';' + this.result.to), this.$cache.input.data('from', this.result.from), this.$cache.input.data('to', this.result.to));
            }
            ...
            this.labels.p_from_left + this.labels.p_from >= this.labels.p_to_left
              ? ((this.$cache.from[0].style.visibility = 'hidden'),
                ...
                this.result.from === this.result.to
                  ? ((this.$cache.from[0].style.visibility = 'visible'), (this.$cache.single[0].style.visibility = 'hidden'), (d = c))
                  : ((this.$cache.from[0].style.visibility = 'hidden'), (this.$cache.single[0].style.visibility = 'visible'), (d = Math.max(a, c))))
