...
*/
  $.fn.toggles = function (d) {
    ...
    d = d || {};
    var a = $.extend(
        { drag: !0, click: !0, text: { on: 'ON', off: 'OFF' }, on: !1, animate: 250, transition: 'ease-in-out', checkbox: null, clicker: null, width: 50, height: 20, type: 'compact' },
        d
      ),
      k = 'select' == a.type;
    ...
    return this.each(function () {
      ...
      l.css({ height: b, width: s, marginLeft: k ? '' : -m, textAlign: 'center', textIndent: k ? '' : m, lineHeight: b + 'px' })
        .html(a.text.off)
        .addClass('active');
