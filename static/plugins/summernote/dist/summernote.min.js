...
!(function (a) {
  ...
  var h,
          ...
          (this.getPoints = function () {
            ...
            (this.normalize = function () {
              var a = function (a, b) {
                  if (
                    ...
                    (n.isVisiblePoint(a) && n.isBlock(a.node) && n.isEmpty(a.node))
                  )
                    return a;
            ...
            (this.splitText = function () {
              var a = b === f,
                c = this.getPoints();
              return (
                n.isText(f) && !n.isEdgePoint(this.getEndPoint()) && f.splitText(g),
                n.isText(b) && !n.isEdgePoint(this.getStartPoint()) && ((c.sc = b.splitText(e)), (c.so = 0), a && ((c.ec = c.sc), (c.eo = g - e))),
      ...
      return {
        create: function (a, c, e, f) {
          if (arguments.length) 2 === arguments.length && ((e = a), (f = c));
            ...
            var m = b(l, !0),
              o = b(k, !1);
            n.isText(m.node) && n.isLeftEdgePoint(m) && n.isTextNode(o.node) && n.isRightEdgePoint(o) && o.node.nextSibling === m.node && (m = o),
              (a = m.cont),
              (c = m.offset),
              (e = o.cont),
              (f = o.offset);
        ...
        createFromNode: function (a) {
          ...
          return (
            ...
            n.isBR(d) ? ((e = n.listPrev(d).length - 1), (d = d.parentNode)) : n.isVoid(d) && ((e = n.listPrev(d).length), (d = d.parentNode)),
            this.create(b, c, d, e)
          );
        },
    ...
    p = {
      ...
      options: {
        ...
        iconPrefix: 'fa fa-',
        icons: {
          font: { bold: 'bold', italic: 'italic', underline: 'underline', clear: 'eraser', height: 'text-height', strikethrough: 'strikethrough', superscript: 'superscript', subscript: 'subscript' },
          image: {
            image: 'picture-o',
      ...
      (this.fromNode = function (a) {
        ...
        (this.current = function (b) {
          var c = a(n.isText(b.sc) ? b.sc.parentNode : b.sc),
            d = this.fromNode(c);
          if (
            ((d['font-bold'] = document.queryCommandState('bold') ? 'bold' : 'normal'),
            (d['font-italic'] = document.queryCommandState('italic') ? 'italic' : 'normal'),
            (d['font-underline'] = document.queryCommandState('underline') ? 'underline' : 'normal'),
            (d['font-strikethrough'] = document.queryCommandState('strikeThrough') ? 'strikethrough' : 'normal'),
            (d['font-superscript'] = document.queryCommandState('superscript') ? 'superscript' : 'normal'),
            (d['font-subscript'] = document.queryCommandState('subscript') ? 'subscript' : 'normal'),
            b.isOnList())
          ) {
          ...
          return (
            a.each(b, function (b, e) {
              var f = k.head(e),
                ...
                i = h.childNodes.length > 1 ? n.splitTree(h, { node: g.parentNode, offset: n.position(g) + 1 }, { isSkipPaddingBlankHTML: !0 }) : null,
                j = n.splitTree(h, { node: f.parentNode, offset: n.position(f) }, { isSkipPaddingBlankHTML: !0 });
              (e = c ? n.listDescendant(j, n.isLi) : k.from(j.childNodes).filter(n.isLi)),
          ...
          if (n.isControlSizing(d.target)) {
            ...
            c
              .on('mousemove', function (a) {
                b.invoke('editor.resizeTo', { x: a.clientX - l.left, y: a.clientY - (l.top - m) }, k, !a.shiftKey),
    ...
    F = function (b) {
      ...
      this.toggle = function (a) {
        ...
        j
          ...
          : (c.off('resize'), i({ h: g.data('orgheight') }), d.css('overflow', 'visible')),
      ...
      (this.sync = function (b) {
        ...
        (this.deactivate = function (b) {
          ...
          f.html(k),
            ...
            l && a.bindCustomEvent(c, f.data('callbacks'), 'change')(f.html(), f),
            f.focus(),
    ...
    I = function (b) {
      ...
      this.attach = function (f) {
        (i.isMSIE && i.browserVersion > 10) || i.isFF
          ? ((c = a('<div />').attr('contenteditable', !0).css({ position: 'absolute', left: -1e5, opacity: 0 })),
      ...
      var h = function (a) {
        ...
        t = function (b, c) {
          ...
          h.css({ width: k.c + 'em', height: k.r + 'em' }),
            ...
            3 < k.c && k.c < c.insertTableMaxSize.col && i.css({ width: k.c + 1 + 'em' }),
            3 < k.r && k.r < c.insertTableMaxSize.row && i.css({ height: k.r + 1 + 'em' }),
            f.html(k.c + ' x ' + k.r);
        };
      (this.bindKeyMap = function (b, d) {
        ...
        g.on('keydown', function (h) {
          ...
          if (m) {
            ...
            (k = a.summernote.pluginEvents[m]),
              a.isFunction(k) ? k(h, c.editor, b) : c.editor[m] ? (c.editor[m](g, f.data('options')), h.preventDefault()) : e[m] && (e[m].call(this, b), h.preventDefault());
        ...
        (this.attach = function (a, b) {
          b.shortcuts && this.bindKeyMap(a, b.keyMap[i.isMac ? 'mac' : 'pc']),
            ...
            b.airMode || (a.toolbar().on('click', o), a.toolbar().on('mousedown', m), c.statusbar.attach(a, b));
        ...
        (this.attachCustomEvent = function (b, c) {
          ...
          f.on(h, function () {
            ...
            c.airMode || (b.toolbar().click(d(e, g, 'toolbar.click')), b.popover().click(d(e, g, 'popover.click'))),
    ...
    N = function () {
      var b = function (a, b) {
        ...
        g = {
          ...
          fontname: function (a, c) {
            var d = [],
              e = c.fontNames.reduce(function (a, b) {
                return i.isFontInstalled(b) || k.contains(c.fontNamesIgnoreCheck, b)
                  ? (d.push(b),
                    a + '<li><a data-event="fontName" href="#" data-value="' + b + '" style="font-family:\'' + b + '\'"><i class="' + c.iconPrefix + c.icons.misc.check + '"></i> ' + b + '</a></li>')
                  : a;
              }, ''),
          ...
          color: function (a, c) {
            var d = '<i class="' + c.iconPrefix + c.icons.color.recent + '" style="color:black;background-color:yellow;"></i>',
              e = b(d, { className: 'note-recent-color', title: a.color.recent, event: 'color', value: '{"backColor":"yellow"}' }),
              g = [
                '<li><div class="btn-group">',
                '<div class="note-palette-title">' + a.color.background + '</div>',
                '<div class="note-color-reset" data-event="backColor"',
                ' data-value="inherit" title="' + a.color.transparent + '">' + a.color.setTransparent + '</div>',
                '<div class="note-color-palette" data-target-event="backColor"></div>',
                '</div><div class="btn-group">',
                '<div class="note-palette-title">' + a.color.foreground + '</div>',
                '<div class="note-color-reset" data-event="foreColor" data-value="inherit" title="' + a.color.reset + '">',
        ...
        h = function (e, f) {
          var h = function () {
            ...
            i = function () {
              var a = b('<span class="note-fontsize-10">100%</span>', { title: e.image.resizeFull, event: 'resize', value: '1' }),
                g = b('<span class="note-fontsize-10">50%</span>', { title: e.image.resizeHalf, event: 'resize', value: '0.5' }),
                h = b('<span class="note-fontsize-10">25%</span>', { title: e.image.resizeQuarter, event: 'resize', value: '0.25' }),
                i = c(f.iconPrefix + f.icons.image.floatLeft, { title: e.image.floatLeft, event: 'floatMe', value: 'left' }),
                j = c(f.iconPrefix + f.icons.image.floatRight, { title: e.image.floatRight, event: 'floatMe', value: 'right' }),
                k = c(f.iconPrefix + f.icons.image.floatNone, { title: e.image.floatNone, event: 'floatMe', value: 'none' }),
                l = c(f.iconPrefix + f.icons.image.shapeRounded, { title: e.image.shapeRounded, event: 'imageShape', value: 'img-rounded' }),
                m = c(f.iconPrefix + f.icons.image.shapeCircle, { title: e.image.shapeCircle, event: 'imageShape', value: 'img-circle' }),
                n = c(f.iconPrefix + f.icons.image.shapeThumbnail, { title: e.image.shapeThumbnail, event: 'imageShape', value: 'img-thumbnail' }),
                o = c(f.iconPrefix + f.icons.image.shapeNone, { title: e.image.shapeNone, event: 'imageShape', value: '' }),
                p = c(f.iconPrefix + f.icons.image.remove, { title: e.image.remove, event: 'removeMedia', value: 'none' }),
                q =
                  (f.disableResizeImage ? '' : '<div class="btn-group">' + a + g + h + '</div>') +
                  '<div class="btn-group">' +
                  i +
                  j +
                  k +
        ...
        l = function (a) {
          return (
            ...
            ' note-control-se"></div>' +
            (a.disableResizeImage ? '' : '<div class="note-control-selection-info"></div>') +
            '</div></div>'
          );
        },
        m = function (a, b) {
        ...
        v = {
          ...
          link: function (a, b) {
            var c =
                ...
                (b.disableLinkTarget ? '' : '<div class="checkbox"><label><input type="checkbox" checked> ' + a.link.openInNewWindow + '</label></div>'),
      ...
      (this.createLayoutByAirMode = function (b, c) {
        ...
        (this.removeLayout = function (a, b, c) {
          c.airMode
            ? (a.removeClass('note-air-editor note-editable').removeAttr('id contentEditable'), b.popover().remove(), b.handle().remove(), b.dialog().remove())
            : (a.html(b.editable().html()), c.dialogsInBody && b.dialog().remove(), b.editor().remove(), a.show());
        }),
  ...
  var O = new N(),
    P = new M();
  a.extend(a.summernote, { renderer: O, eventHandler: P, core: { agent: i, list: k, dom: n, range: o }, pluginEvents: {}, plugins: [] }),
