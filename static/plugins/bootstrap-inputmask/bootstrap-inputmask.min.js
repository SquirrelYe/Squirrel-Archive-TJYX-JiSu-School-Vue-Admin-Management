...
!(function (e) {
  ...
  (r.prototype = {
        ...
        e.each(
          ...
          e.proxy(function (e, r) {
            r == '?'
              ...
              : t[r]
              ? (this.tests.push(new RegExp(t[r])), this.firstNonMaskPos === null && (this.firstNonMaskPos = this.tests.length - 1))
    ...
    (e.fn.inputmask.defaults = { mask: '', placeholder: '_', definitions: { 9: '[0-9]', a: '[A-Za-z]', '?': '[A-Za-z0-9]', '*': '.' } }),
