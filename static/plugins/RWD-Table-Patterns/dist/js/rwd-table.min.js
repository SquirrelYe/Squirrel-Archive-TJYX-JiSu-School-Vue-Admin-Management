...
!(function (a) {
  ...
  (e.DEFAULTS = { pattern: 'priority-columns', stickyTableHeader: !0, fixedNavbar: '.navbar-fixed-top', addDisplayAllBtn: !0, addFocusBtn: !0, focusBtnIcon: 'glyphicon glyphicon-screenshot' }),
    ...
    (e.prototype.updateStickyTableHeader = function () {
      ...
      if (h) {
        if (
          ...
          (c = i - 1),
          e - d > f ? ((c -= e - d - f), b.$stickyTableHeader.addClass('border-radius-fix')) : b.$stickyTableHeader.removeClass('border-radius-fix'),
          k)
        )
          return void b.$stickyTableHeader.css({ visibility: 'visible', top: c + 'px', width: b.$tableScrollWrapper.innerWidth() + 'px' });
        ...
        (c = e - d - 1),
          ...
          g > 0 && (c -= g),
          k
            ? (b.$stickyTableHeader.css({ visibility: 'visible' }), b.$stickyTableHeader.animate({ top: c + 'px' }, l), b.$thead.css({ visibility: 'hidden' }))
            ...
            g
              ...
              .change(function () {
                ...
                b.$table.hasClass('display-all') &&
                  (a.proxy(b.preserveDisplayAll(), b), b.$table.removeClass('display-all'), b.$tableClone && b.$tableClone.removeClass('display-all'), b.$displayAllBtn.removeClass('btn-primary')),
                  e.each(function () {
                    var b = a(this);
                    c.is(':checked')
                      ? ('none' !== b.css('display') && b.prop('colSpan', parseInt(b.prop('colSpan')) + 1), b.show())
