    ...
    function f(b) {
      ...
      function f(a) {
        if ((d(), 'string' == typeof a && (a = document.querySelector(a)), a && 'object' == typeof a && a.nodeType)) {
          ...
          var z = c(b.height);
          return (
            z !== !1 && (f.height = z + (x ? 0 : s + w)), (f.innerWidth = f.width - (r + v)), (f.innerHeight = f.height - (s + w)), (f.outerWidth = f.width + t), (f.outerHeight = f.height + u), f
          );
        }
      }
      function i(b, c) {
  ...
  (function (a, b) {
    ...
    e.extend(g.prototype, b.prototype),
      ...
      (g.prototype.getTranslate = function (a, b) {
        ...
        return (
          (a = c.isOriginLeft ? a : -a), (b = c.isOriginTop ? b : -b), (a = this.getXValue(a)), (b = this.getYValue(b)), n ? 'translate3d(' + a + ', ' + b + ', 0)' : 'translate(' + a + ', ' + b + ')'
        );
      }),
  ...
  (function (a, b) {
    ...
    return (
      ...
      (d.prototype._getItemLayoutPosition = function (a) {
        ...
        for (
          var f = this._getColGroup(e), g = Math.min.apply(Math, f), h = c.indexOf(f, g), i = { x: this.columnWidth * h, y: g }, j = g + a.size.outerHeight, k = this.cols + 1 - f.length, l = 0;
          k > l;
          l++
        )
          this.colYs[h + l] = j;
