...
!(function (a) {
  ...
  (function (a, b) {
    ...
    function E(a, b, c, d) {
      ...
      return 0 > e
        ? (c.push(d(a)), void 0)
        : (c.push(d(a.substring(0, e))), c.push("<span class='select2-match'>"), c.push(d(a.substring(e, e + f))), c.push('</span>'), c.push(d(a.substring(e + f, a.length))), void 0);
    }
    function F(a) {
      var b = { '\\': '&#92;', '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;', '/': '&#47;' };
        ...
        (d = O(Object, {
          ...
          init: function (c) {
            ...
            (this.opts = c = this.prepareOpts(c)),
              ...
              (this.liveRegion = a('<span>', { role: 'status', 'aria-live': 'polite' }).addClass('select2-hidden-accessible').appendTo(document.body)),
          ...
          prepareOpts: function (c) {
            ...
            if (
              (e
                ...
                : 'query' in c ||
                  ('ajax' in c
                    ? ((h = c.element.data('ajax-url')), h && h.length > 0 && (c.ajax.url = h), (c.query = G.call(c.element, c.ajax)))
                    : 'data' in c
                    ? (c.query = H(c.data))
                    : 'tags' in c &&
                      ((c.query = I(c.tags)),
          ...
          positionDropdown: function () {
            ...
            s ? ((u = !0), !p && o && ((v = !0), (u = !1))) : ((u = !1), !o && p && ((v = !0), (u = !0))),
              ...
              (w = { left: n, width: e }),
              u
                ? ((w.top = c.top - f), (w.bottom = 'auto'), this.container.addClass('select2-drop-above'), b.addClass('select2-drop-above'))
          ...
          updateResults: function (c) {
            ...
            if ((c === !0 || !k || !r(j, k)) && (a.data(this.container, 'select2-last-term', j), c === !0 || (this.showSearchInput !== !1 && this.opened()))) {
              ...
              if (d.val().length < f.minimumInputLength)
                return (
                  J(f.formatInputTooShort, 'formatInputTooShort') ? n("<li class='select2-no-results'>" + K(f.formatInputTooShort, d.val(), f.minimumInputLength) + '</li>') : n(''),
                    ...
                    if (l == this.queryCount) {
                      ...
                      e.empty(),
                        ...
                        g.more === !0 &&
                          ...
                          (e.append("<li class='select2-more-results'>" + h.opts.escapeMarkup(K(f.formatLoadMore, this.resultsPage)) + '</li>'),
                          window.setTimeout(function () {
                            h.loadMoreIfNeeded();
                          }, 10)),
        ...
        (e = O(d, {
          ...
          isPlaceholderOptionSelected: function () {
            ...
            return this.getPlaceholder() === b
              ? !1
              : ((a = this.getPlaceholderOption()) !== b && a.prop('selected')) || '' === this.opts.element.val() || this.opts.element.val() === b || null === this.opts.element.val();
          },
              ...
              this.opts.closeOnSelect
                ...
                ? (this.search.width(10),
                  ...
                  this.getMaximumSelectionSize() > 0 && this.val().length >= this.getMaximumSelectionSize()
                    ? this.updateResults(!0)
                    : this.nextSearchTerm != b && (this.search.val(this.nextSearchTerm), this.updateResults(), this.search.select()),
                  this.positionDropdown())
                : (this.close(), this.search.width(10)),
              ...
              d &&
                g
                  ...
                  .on(
                    ...
                    this.bind(function (b) {
                      this.isInterfaceEnabled() &&
                        (this.unselect(a(b.target)), this.selection.find('.select2-search-choice-focus').removeClass('select2-search-choice-focus'), A(b), this.close(), this.focusSearch());
                    })
                  )
                  .on(
                    'focus',
          ...
          postprocessResults: function (a, b, c) {
            ...
            e.each2(function (a, b) {
              ...
              !this.opts.createSearchChoice &&
                ...
                this.results.append("<li class='select2-no-results'>" + K(g.opts.formatNoMatches, g.search.val()) + '</li>');
          },
          ...
          return (
            this.each(function () {
              if (0 === c.length || 'object' == typeof c[0])
                ...
                if (
                  ((f = c[0]),
                  'container' === f ? (g = e.container) : 'dropdown' === f ? (g = e.dropdown) : (l[f] && (f = l[f]), (g = e[f].apply(e, c.slice(1)))),
