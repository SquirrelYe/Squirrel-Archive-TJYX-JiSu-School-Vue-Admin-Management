...
!(function (a) {
  ...
  function d(b) {
    ...
    return (
      a.each(b, function (b, e) {
        'views' != b &&
          (a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, La)
            ? ((c = null),
  ...
  function A(a, b) {
    var c,
      ...
      j = b.end;
    return h > i && j > g
      ? (g >= i ? ((c = g.clone()), (e = !0)) : ((c = i.clone()), (e = !1)), j >= h ? ((d = h.clone()), (f = !0)) : ((d = j.clone()), (f = !1)), { start: c, end: d, isStart: e, isEnd: f })
      : void 0;
  }
  function B(a, c) {
  ...
  function Z(c, d, e) {
    ...
    return (
      b.isMoment(j)
        ...
        : ((f = !1),
          (g = !1),
          k ? (Ta.test(j) ? ((j += '-01'), (c = [j]), (f = !0), (g = !0)) : (h = Ua.exec(j)) && ((f = !h[5]), (g = !0))) : a.isArray(j) && (g = !0),
  ...
  function za(a, b, c) {
    ...
    if (void 0 === a.forwardCoord)
      for (
        e.length ? (e.sort(Ca), za(e[0], b + 1, c), (a.forwardCoord = e[0].backwardCoord)) : (a.forwardCoord = 1), a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / (b + 1), d = 0;
        d < e.length;
        d++
      )
  ...
  function Da(c, d) {
    ...
    function f() {
      (V = P.theme ? 'ui' : 'fc'),
        ...
        T && c.prepend(T),
        i(P.defaultView),
        P.handleWindowResize && ((Z = Y(m, P.windowResizeDelay)), a(window).resize(Z));
    }
    function g() {
    ...
    function i(b) {
      da++,
        W && b && W.type !== b && (S.deactivateButton(W.type), H(), W.removeElement(), (W = O.view = null)),
        !W && b && ((W = O.view = ca[b] || (ca[b] = O.instantiateView(b))), W.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(U)), S.activateButton(b)),
        W && (($ = W.massageCurrentDate($)), (W.displaying && $.isWithin(W.intervalStart, W.intervalEnd)) || (h() && (H(), W.display($), I(), u(), v(), q()))),
        I(),
        da--;
    }
    function j(a) {
    ...
    function l() {
      X = 'number' == typeof P.contentHeight ? P.contentHeight : 'number' == typeof P.height ? P.height - (T ? T.outerHeight(!0) : 0) : Math.round(U.width() / Math.max(P.aspectRatio, 0.5));
    }
    function m(a) {
      ...
      (O.moment = function () {
        ...
        return (
          'local' === P.timezone
            ...
            : (a = 'UTC' === P.timezone ? Ja.moment.utc.apply(null, arguments) : Ja.moment.parseZone.apply(null, arguments)),
            ...
            a.each(this.split(','), function (d, e) {
              ...
              'title' == e
                ...
                : ((f = b.getViewSpec(e)),
                  ...
                  i &&
                    ...
                    (m = c.buttonIcons[e]),
                    (o = j ? R(j) : l && c.theme ? "<span class='ui-icon ui-icon-" + l + "'></span>" : m && !c.theme ? "<span class='fc-icon fc-icon-" + m + "'></span>" : R(k)),
                    (q = ['fc-' + e + '-button', n + '-button', n + '-state-default']),
                    (r = a('<button type="button" class="' + q.join(' ') + '">' + o + '</button>')
                      .click(function () {
              ...
              h &&
                g
                  ...
                  .end(),
              g.length > 1 ? ((f = a('<div/>')), h && f.addClass('fc-button-group'), f.append(g), e.append(f)) : e.append(g);
          }),
        e
      );
    }
  ...
  function Ha(c) {
    ...
    function v(a) {
      null == a.allDay && (a.allDay = !(a.start.hasTime() || (a.end && a.end.hasTime()))),
        a.allDay ? (a.start.stripTime(), a.end && a.end.stripTime()) : (a.start.hasTime() || (a.start = M.rezoneDate(a.start)), a.end && !a.end.hasTime() && (a.end = M.rezoneDate(a.end)));
    }
    function w(b) {
      var c;
      ...
      if (((c = c || N), (d = d || R), b))
        if (b._recurring) {
          ...
          for (h = c.clone().stripTime(); h.isBefore(d); )
            (!e || e[h.day()]) && ((i = b.start), (j = b.end), (k = h.clone()), (l = null), i && (k = k.time(i)), j && (l = h.clone().time(j)), (m = a.extend({}, b)), t(k, l, !i && !j, m), n.push(m)),
              h.add(1, 'days');
        } else n.push(b);
      return n;
    }
    function y(b, c, d) {
      ...
      return (
        ...
        u(c),
        (f = { start: b._start.clone(), end: b._end ? b._end.clone() : M.getDefaultEventEnd(b._allDay, b._start), allDay: c.allDay }),
        u(f),
      ...
      return (
        ...
        a.each(b, function (b, j) {
          ...
          (k = { start: j.start.clone(), end: j.end ? j.end.clone() : null, allDay: j.allDay }),
            ...
            u(l),
            c ? (l.end = null) : f && !l.end && (l.end = M.getDefaultEventEnd(l.allDay, l.start)),
    ...
    (Va.isSame = function (a, b) {
      ...
      return this._fullCalendar
        ? b
          ...
          : ((a = Ja.moment.parseZone(a)), Wa.isSame.call(this, a) && Boolean(this._ambigTime) === Boolean(a._ambigTime) && Boolean(this._ambigZone) === Boolean(a._ambigZone))
  ...
  var $a = ka.extend({
      ...
      position: function () {
        ...
        (e = g.top || 0),
          ...
          g.viewportConstrain !== !1 &&
            ((e = Math.min(e, b + l.outerHeight() - j - this.margin)), (e = Math.max(e, b + this.margin)), (f = Math.min(f, c + l.outerWidth() - i - this.margin)), (f = Math.max(f, c + this.margin))),
    ...
    bb = (Ja.DragListener = ka.extend({
      ...
      startListening: function (b) {
        ...
        this.isListening ||
          (b &&
            this.options.scroll &&
            ((c = n(a(b.target))),
            c.is(window) || c.is(document) || ((this.scrollEl = c), (this.scrollHandlerProxy = Y(X(this, 'scrollHandler'), 100)), this.scrollEl.on('scroll', this.scrollHandlerProxy))),
          a(document)
      ...
      setScrollVel: function (a, b) {
        (this.scrollTopVel = a),
          ...
          (!this.scrollTopVel && !this.scrollLeftVel) || this.scrollIntervalId || (this.scrollIntervalId = setInterval(X(this, 'scrollIntervalFunc'), this.scrollIntervalMs));
      },
    ...
    db = ka.extend({
      ...
      start: function (b) {
        this.isFollowing ||
          ...
          a(document).on('mousemove', (this.mousemoveProxy = X(this, 'mousemove'))));
      },
      stop: function (b, c) {
        function d() {
        ...
        this.isFollowing &&
          ...
          b && f && !this.isHidden ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: f, complete: d })) : d());
      },
      getEl: function () {
        var a = this.el;
        return (
    ...
    fb = (Ja.Grid = eb.extend({
      ...
      getCell: function (b, c) {
        var d;
        return (
          null == c && ('number' == typeof b ? ((c = b % this.colCnt), (b = Math.floor(b / this.colCnt))) : ((c = b.col), (b = b.row))),
          (d = { row: b, col: c }),
  ...
  fb.mixin({
    ...
    externalDragStart: function (b, c) {
      var d,
        ...
        f = this.view;
      f.opt('droppable') &&
        ((d = a((c ? c.item : null) || b.target)), (e = f.opt('dropAccept')), (a.isFunction(e) ? e.call(d[0], d) : d.is(e)) && (this.isDraggingExternal || this.listenToExternalDrag(d, b, c)));
    },
      ...
      (d = new cb(this.coordMap, {
        ...
        cellOver: function (b, d, h) {
          (e = c ? f.computeEventStartResize(h, b, l) : f.computeEventEndResize(h, b, l)),
            e && (j.isEventRangeAllowed(e, l) ? e.start.isSame(l.start) && e.end.isSame(m) && (e = null) : (g(), (e = null))),
    ...
    eventsToInverseRanges: function (a) {
      var b,
        ...
        i = a[0],
        j = e;
      for (g.sort(qa), b = 0; b < g.length; b++) (c = g[b]), c.start > j && h.push({ event: i, start: j, end: c.start }), (j = c.end);
  ...
  var gb = fb.extend({
    ...
    updateCellDates: function () {
      for (var a = this.view, b = this.start.clone(), c = [], d = -1, e = []; b.isBefore(this.end); ) a.isHiddenDay(b) ? e.push(d + 0.5) : (d++, e.push(d), c.push(b.clone())), b.add(1, 'days');
  ...
  gb.mixin({
    ...
    fgSegHtml: function (a, b) {
      ...
      return (
        ...
        a.isStart && ((c = this.getEventTimeText(f)), c && (l = '<span class="fc-time">' + R(c) + '</span>')),
        (d = '<span class="fc-title">' + (R(f.title || '') || '&nbsp;') + '</span>'),
        '<a class="' +
          j.join(' ') +
          '"' +
          (f.url ? ' href="' + R(f.url) + '"' : '') +
      ...
      for (e = 0; n > e; e++) {
        if (((f = m[e]), (g = 0), (h = a('<tr/>')), p.push([]), q.push([]), r.push([]), f))
          for (i = 0; i < f.length; i++) {
            for (
              j = f[i], d(j.leftCol), k = a('<td class="fc-event-container"/>').append(j.el), j.leftCol != j.rightCol ? k.attr('colspan', j.rightCol - j.leftCol + 1) : (r[e][g] = k);
              g <= j.rightCol;
      ...
      renderMoreLink: function (b, c) {
        ...
        return a('<a class="fc-more"/>')
          ...
          .on('click', function (f) {
            ...
            'function' == typeof g && (g = e.trigger('eventLimitClick', null, { date: h, dayEl: j, moreEl: i, segs: l, hiddenSegs: m }, f)),
  ...
  var hb = fb.extend({
    ...
    slatRowHtml: function () {
      for (var a, c, d, e = this.view, f = this.isRTL, g = '', h = this.slotDuration.asMinutes() % 15 === 0, i = b.duration(+this.minTime); i < this.maxTime; )
        (a = this.start.clone().time(i)),
          (c = a.minutes()),
          (d = '<td class="fc-axis fc-time ' + e.widgetContentClass + '" ' + e.axisStyleAttr() + '>' + (h && c ? '' : '<span>' + R(a.format(this.axisFormat)) + '</span>') + '</td>'),
    ...
    renderFill: function (b, c, d) {
      ...
      if (c.length) {
        for (
          c = this.renderFillSegEls(b, c), e = this.groupSegCols(c), d = d || b.toLowerCase(), f = a('<div class="fc-' + d + '-skeleton"><table><tr/></table></div>'), g = f.find('tr'), h = 0;
          h < e.length;
          h++
        )
    ...
    fgSegHtml: function (a, b) {
      ...
      return (
        ...
        '<a class="' +
          ...
          (l ? ' style="' + l + '"' : '') +
          '><div class="fc-content">' +
          (c ? '<div class="fc-time" data-start="' + R(e) + '" data-full="' + R(d) + '"><span>' + R(c) + '</span></div>' : '') +
  ...
  var ib = (Ja.View = ka.extend({
      ...
      computeRange: function (a) {
        ...
        return (
          /year|month|week|day/.test(d) ? (e.stripTime(), f.stripTime()) : (e.hasTime() || (e = this.calendar.rezoneDate(e)), f.hasTime() || (f = this.calendar.rezoneDate(f))),
          (b = e.clone()),
    ...
    jb = (Ja.Calendar = ka.extend({
      ...
      buildViewSpec: function (a) {
        ...
        return (
          ...
          (d.type = a),
          d['class']
            ? (f && ((f = b.duration(f)), f.valueOf() && ((d.duration = f), (g = E(f)), 1 === f.as(g) && ((d.singleUnit = g), k.unshift(h[g] || {})))),
              (d.defaults = c(j)),
              (d.overrides = c(k)),
      ...
      buildViewSpecButtonText: function (a, b) {
        ...
        (a.buttonTextOverride = c(this.overrides) || a.overrides.buttonText),
          (a.buttonTextDefault = c(this.langDefaults) || c(this.dirDefaults) || a.defaults.buttonText || c(jb.defaults) || (a.duration ? this.humanizeDuration(a.duration) : null) || b);
      },
  ...
  var qb = ib.extend({
      ...
      computeRange: function (a) {
        ...
        return (
          /year|month/.test(b.intervalUnit) &&
            (b.start.startOf('week'), (b.start = this.skipHiddenDays(b.start)), b.end.weekday() && (b.end.add(1, 'week').startOf('week'), (b.end = this.skipHiddenDays(b.end, -1, !0)))),
          b
        );
      },
      renderDates: function () {
      ...
      headIntroHtml: function () {
        return this.weekNumbersVisible
          ? '<th class="fc-week-number ' + this.widgetHeaderClass + '" ' + this.weekNumberStyleAttr() + '><span>' + R(this.opt('weekNumberTitle')) + '</span></th>'
          : void 0;
      },
      ...
      numberCellHtml: function (a) {
        ...
        return this.dayNumbersVisible
          ? ((b = this.dayGrid.getDayClasses(c)), b.unshift('fc-day-number'), '<td class="' + b.join(' ') + '" data-date="' + c.format() + '">' + c.date() + '</td>')
          : '<td/>';
      },
      ...
      setHeight: function (a, b) {
        ...
        m(this.scrollerEl),
          ...
          d && 'number' != typeof d && this.dayGrid.limitRows(d),
          !b && l(this.scrollerEl, c) && (e(this.headRowEl, r(this.scrollerEl)), (c = this.computeScrollerHeight(a)), this.scrollerEl.height(c));
      },
  ...
  var sb = ib.extend({
      ...
      initialize: function () {
        (this.timeGrid = new hb(this)),
          this.opt('allDaySlot') ? ((this.dayGrid = new gb(this)), (this.coordMap = new ab([this.dayGrid.coordMap, this.timeGrid.coordMap]))) : (this.coordMap = this.timeGrid.coordMap);
      },
      setRange: function (a) {
      ...
      headIntroHtml: function () {
        ...
        return this.opt('weekNumbers')
          ? ((a = this.timeGrid.getCell(0).start),
            ...
            '<th class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + '><span>' + R(b) + '</span></th>')
      ...
      setHeight: function (a, b) {
        ...
        null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()),
          ...
          this.dayGrid && (this.dayGrid.removeSegPopover(), (c = this.opt('eventLimit')), c && 'number' != typeof c && (c = tb), c && this.dayGrid.limitRows(c)),
          b ||
            ((d = this.computeScrollerHeight(a)),
            l(this.scrollerEl, d)
              ? (e(this.noScrollRowEls, r(this.scrollerEl)), (d = this.computeScrollerHeight(a)), this.scrollerEl.height(d))
    ...
    tb = 5;
  return (
    (Ka.agenda = { class: sb, defaults: { allDaySlot: !0, allDayText: 'all-day', slotDuration: '00:30:00', minTime: '00:00:00', maxTime: '24:00:00', slotEventOverlap: !0 } }),
