  ...
  (b = window.Morris = {}),
            ...
            null == a || 0 === a.length
              ...
              : ((o = this.cumulative ? 0 : null),
                ...
                this.options.goals.length > 0 &&
                  ((h = Math.min.apply(Math, this.options.goals)), (g = Math.max.apply(Math, this.options.goals)), (p = null != p ? Math.min(p, h) : h), (o = null != o ? Math.max(o, g) : g)),
                (this.data = function () {
                  var c, d, g;
    ...
    (b.Line = (function (a) {
      ...
      return (
        ...
        (c.prototype.draw = function () {
          var a;
          return (
            ((a = this.options.axes) === !0 || 'both' === a || 'x' === a) && this.drawXAxis(), this.drawSeries(), this.options.hideHover === !1 ? this.displayHoverForRow(this.data.length - 1) : void 0
          );
        }),
          ...
          for (
            ...
            (h = this.data[this.data.length - 1 - a]),
              ...
              (null == g || g >= c.x + c.width || (null != f && f >= c.x)) && c.x >= 0 && c.x + c.width < this.el.width()
                ? (0 !== this.options.xLabelAngle && ((d = (1.25 * this.options.gridTextSize) / Math.sin((this.options.xLabelAngle * Math.PI) / 180)), (f = c.x - d)),
    ...
    (b.Donut = (function (c) {
      function d(c) {
        ...
        if (
          ((this.options = a.extend({}, this.defaults, c)), (this.el = 'string' == typeof c.element ? a(document.getElementById(c.element)) : a(c.element)), null === this.el || 0 === this.el.length)
        )
