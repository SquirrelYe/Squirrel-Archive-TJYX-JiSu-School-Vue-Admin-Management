        ...
        for (c = s.snapElements.length - 1; c >= 0; c--)
          (h = s.snapElements[c].left - s.margins.left),
            ...
            h - m > v || g > l + m || u - m > b || y > d + m || !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ? (s.snapElements[c].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), { snapItem: s.snapElements[c].item })),
      ...
      _setOption: function (e, t) {
        ...
        'dialogClass' === e && n.removeClass(this.options.dialogClass).addClass(t),
          'disabled' !== e &&
            ...
            'resizable' === e &&
              ((s = n.is(':data(ui-resizable)')), s && !t && n.resizable('destroy'), s && 'string' == typeof t && n.resizable('option', 'handles', t), s || t === !1 || this._makeResizable()),
  ...
  (e.effects = { effect: {} }),
    ...
    (e.effects.effect.size = function (t, i) {
      ...
      'show' === p && o.show(),
        ...
        ('content' === m || 'both' === m) &&
          a.from.y !== a.to.y &&
          ((y = y.concat(u).concat(l)), (o.from = e.effects.setTransition(o, u, a.from.y, o.from)), (o.to = e.effects.setTransition(o, u, a.to.y, o.to))),
        e.effects.save(o, y),
        o.show(),
        e.effects.createWrapper(o),
    ...
    (e.effects.effect.shake = function (t, i) {
      var s,
        ...
        y = v.length;
      for (
        e.effects.save(n, a), n.show(), e.effects.createWrapper(n), f[c] = (p ? '-=' : '+=') + h, m[c] = (p ? '+=' : '-=') + 2 * h, g[c] = (p ? '-=' : '+=') + 2 * h, n.animate(f, d, t.easing), s = 1;
        l > s;
        s++
      )
    ...
    e.widget('ui.selectmenu', {
      ...
      _renderMenu: function (t, i) {
        ...
        e.each(i, function (i, a) {
          a.optgroup !== n &&
            (e('<li>', { class: 'ui-selectmenu-optgroup ui-menu-divider' + (a.element.parent('optgroup').prop('disabled') ? ' ui-state-disabled' : ''), text: a.optgroup }).appendTo(t),
            (n = a.optgroup)),
      ...
      _contactContainers: function (t) {
        ...
        if (c)
          if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger('over', t, this._uiHash(this)), (this.containers[p].containerCache.over = 1));
            ...
            for (
              n = 1e4, a = null, u = c.floating || this._isFloating(this.currentItem), o = u ? 'left' : 'top', r = u ? 'width' : 'height', d = u ? 'clientX' : 'clientY', s = this.items.length - 1;
              s >= 0;
              s--
            )
