(function (g) {
  ...
  l.ext.buttons.copyHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      a = g(
        '<span>' +
          b.i18n('buttons.copyKeys', 'Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.') +
          '</span>'
      ).append(d);
