...
(function (e) {
  ...
  e.extend(h.prototype, {
    ...
    fnScrollToRow: function (a, b) {
      ...
      0 > j && (j = 0);
      if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== j) (d = !0), (f = this.fnRowToPixels(a, !1, !0));
        ...
        var a = this.s.dt,
          ...
          g =
            0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal()
              ...
              ? b.sInfo.replace('_START_', g).replace('_END_', i).replace('_MAX_', k).replace('_TOTAL_', l) + b.sInfoPostFix
              : b.sInfo.replace('_START_', g).replace('_END_', i).replace('_MAX_', k).replace('_TOTAL_', l) +
                ' ' +
  ...
  h.defaults = { trace: !1, rowHeight: 'auto', serverWait: 200, displayBuffer: 9, boundaryScale: 0.5, loadingIndicator: !1 };
