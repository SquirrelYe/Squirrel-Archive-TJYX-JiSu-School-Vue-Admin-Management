...
(function (Fa, T, k) {
  var S = function (g) {
    ...
    function y(a, b, c, e) {
      ...
      if (c === k)
        return (
          a.iDrawError != d && null === i && (J(a, 0, 'Requested unknown parameter ' + ('function' == typeof f.mData ? '{function}' : "'" + f.mData + "'") + ' for row ' + b, 4), (a.iDrawError = d)), i
        );
      ...
      if (-1 !== g.inArray(!1, b)) C(a, !1);
        ...
        if (0 !== j.length) {
          ...
          (c = f.sZeroRecords),
            ...
            (b[0] = g('<tr/>', { class: d ? e[0] : '' }).append(g('<td />', { valign: 'top', colSpan: ba(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
      ...
      for (j = c.length; f < j; f++) {
        ...
        for (d = e.firstChild; d; ) {
          if ('TD' == d.nodeName.toUpperCase() || 'TH' == d.nodeName.toUpperCase()) {
            ...
            n = h;
            q = 1 === l ? !0 : !1;
            for (i = 0; i < l; i++) for (h = 0; h < r; h++) (a[f + h][n + i] = { cell: d, unique: q }), (a[f + h].nTr = e);
          }
          d = d.nextSibling;
        }
      }
      ...
      j = g('<div/>', { class: f.sScrollWrapper })
        .append(
          g('<div/>', { class: f.sScrollHead })
            .css({ overflow: 'hidden', position: 'relative', border: 0, width: e ? (!e ? null : u(e)) : '100%' })
            .append(
    ...
    function H(a, b, c) {
      for (var e = 0, d = 0, f = b.length, h, i; d < f; ) {
        h = b[d].firstChild;
        for (i = c ? c[d].firstChild : null; h; ) 1 === h.nodeType && (c ? a(h, i, e) : a(h, e), e++), (h = h.nextSibling), (i = c ? i.nextSibling : null);
        d++;
      }
    }
    function Ha(a) {
      ...
      if (e || (!q && !f && !d && i == ba(a) && i == n.length)) for (m = 0; m < i; m++) c[m].sWidth = u(n.eq(m).width());
        ...
        q = g('<div/>')
          .css(f || d ? { position: 'absolute', top: 0, left: 0, height: 1, right: 0, overflow: 'hidden' } : {})
          .append(i)
          .appendTo(k);
        ...
        if (f) {
          for (m = h = 0; m < j.length; m++)
            (o = c[j[m]]), (d = p.bBounding ? n[m].getBoundingClientRect().width : g(n[m]).outerWidth()), (h += null === o.sWidthOrig ? d : parseInt(o.sWidth, 10) + d - g(n[m]).width());
          i.width(u(h));
          b.style.width = u(h);
        }
      ...
      for (a = 0; a < n.length; a++) {
        ...
        for (c = f.length; b < c; b++)
          (h = f[b]),
            ...
            e.push({ src: j, col: h, dir: n[a][1], index: n[a]._idx, type: i, formatter: m.ext.type.order[i + '-pre'] });
      }
      return e;
    }
    function mb(a) {
    ...
    function Kb(a) {
      for (var b, c, e = a.aoColumns, d = V(a), a = a.oLanguage.oAria, f = 0, h = e.length; f < h; f++) {
        ...
        c.bSortable &&
          (0 < d.length && d[0].col == f ? (g.setAttribute('aria-sort', 'asc' == d[0].dir ? 'ascending' : 'descending'), (c = i[d[0].index + 1] || i[0])) : (c = i[0]),
    ...
    function Va(a, b, c, e) {
      ...
      c && a.oFeatures.bSortMulti
        ? ((c = g.inArray(b, D(d, '0'))),
          -1 !== c
            ? ((b = h(d[c], !0)), null === b && 1 === d.length && (b = 0), null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b)))
    ...
    function Lb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          d &&
          d.time &&
          ((b = w(a, 'aoStateLoadParams', 'stateLoadParams', [a, d])), -1 === g.inArray(!1, b) && ((b = a.iStateDuration), !(0 < b && d.time < +new Date() - 1e3 * b) && e.length === d.columns.length))
        ) {
    ...
    function Mb(a, b, c) {
      ...
      for (d in b)
        b.hasOwnProperty(d) &&
          ((e = b[d]), g.isPlainObject(e) ? (g.isPlainObject(a[d]) || (a[d] = {}), g.extend(!0, a[d], e)) : (a[d] = c && 'data' !== d && 'aaData' !== d && g.isArray(e) ? e.slice() : e));
      return a;
    }
    function Wa(a, b, c) {
      g(a)
    ...
    function Aa(a, b) {
      ...
      b <= c
        ...
        : (a >= b - 1 - e ? (c = W(b - (c - 2), b)) : ((c = W(a - e + 2, a + e - 1)), c.push('ellipsis'), c.push(b - 1)), c.splice(0, 0, 'ellipsis'), c.splice(0, 0, 0));
      c.DT_el = 'span';
      return c;
    }
    function db(a) {
    ...
    m = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase()) J(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
          ...
          j = o.oClasses;
          d.bJQueryUI
            ? (g.extend(j, m.ext.oJUIClasses, d.oClasses), d.sDom === l.sDom && 'lfrtip' === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer)
          ...
          null !== d.iDeferLoading &&
            ((o.bDeferLoading = !0), (h = g.isArray(d.iDeferLoading)), (o._iRecordsDisplay = h ? d.iDeferLoading[0] : d.iDeferLoading), (o._iRecordsTotal = h ? d.iDeferLoading[1] : d.iDeferLoading));
          var t = o.oLanguage;
    ...
    t.extend = function (a, b, c) {
      if (c.length && b && (b instanceof t || b.__dt_wrapper)) {
        ...
        for (d = c.length; e < d; e++)
          (f = c[e]), (b[f.name] = 'function' === typeof f.val ? h(a, f.val, f) : g.isPlainObject(f.val) ? {} : f.val), (b[f.name].__dt_wrapper = !0), t.extend(a, b[f.name], f.propExt);
      }
    };
    ...
    p('search()', function (a, b, c, e) {
      ...
      return a === k
        ...
        : this.iterator('table', function (d) {
            d.oFeatures.bFilter && ga(d, g.extend({}, d.oPreviousSearch, { sSearch: a + '', bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === e ? !0 : e }), 1);
          });
    });
    s('columns().search()', 'column().search()', function (a, b, c, e) {
      return this.iterator('column', function (d, f) {
        ...
        d.oFeatures.bFilter && (g.extend(h[f], { sSearch: a + '', bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === e ? !0 : e }), ga(d, d.oPreviousSearch, 1));
      });
    });
    p('state()', function () {
          ...
          g(a.nTable).on('order.dt.DT', function (d, f, h, g) {
            if (a === f) {
              ...
              b.find('span.' + e.sSortIcon)
                ...
                .addClass(g[d] == 'asc' ? e.sSortJUIAsc : g[d] == 'desc' ? e.sSortJUIDesc : c.sSortingClassJUI);
            }
          });
        }
      }
