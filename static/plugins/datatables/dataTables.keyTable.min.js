  ...
  e.extend(l.prototype, {
    ...
    _focus: function (a, b) {
      ...
      if (this.s.enable) {
        if ('number' !== typeof a) {
          var h = a.index(),
            b = h.column,
            a = c.rows({ filter: 'applied', order: 'applied' }).indexes().indexOf(h.row);
        ...
        if (-1 !== f.length && (a < f.start || a >= f.start + f.length))
          ...
          h !== c.table().header().parentNode && ((h = e(h.parentNode)), this._scroll(h, h, m, 'position'));
          this.s.lastFocus = f;
    ...
    _shift: function (a, b, d) {
      ...
      if (h) {
        ...
        f = i[c];
        'right' === b ? (c >= i.length - 1 ? (g++, (f = i[0])) : (f = i[c + 1])) : 'left' === b ? (0 === c ? (g--, (f = i[i.length - 1])) : (f = i[c - 1])) : 'up' === b ? g-- : 'down' === b && g++;
        0 <= g && g < j && -1 !== e.inArray(f, i) ? (a.preventDefault(), this._focus(g, f)) : !d || !this.c.blurable ? a.preventDefault() : this._blur();
      }
    },
    _tabInput: function () {
      var a = this,
