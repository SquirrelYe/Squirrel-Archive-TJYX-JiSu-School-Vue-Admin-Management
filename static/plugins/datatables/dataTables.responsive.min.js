  ...
  var n = c.fn.dataTable,
    j = function (a, b) {
      ...
      this.s.dt.settings()[0].responsive ||
        (b && 'string' === typeof b.details && (b.details = { type: b.details }), (this.c = c.extend(!0, {}, j.defaults, n.defaults.responsive, b)), (a.responsive = this), this._constructor());
    };
  c.extend(j.prototype, {
    ...
    _detailsObj: function (a) {
      ...
      return c.map(this.s.columns, function (c, f) {
        if (!c.never) return { title: d.settings()[0].aoColumns[f].sTitle, data: d.cell(a, f).render(b.c.orthogonal), hidden: d.column(f).visible() && !b.s.current[f] };
      });
    },
    _find: function (a) {
