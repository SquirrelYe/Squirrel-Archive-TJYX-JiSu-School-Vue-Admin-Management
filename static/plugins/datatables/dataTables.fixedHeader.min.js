  ...
  d.extend(i.prototype, {
    ...
    _clone: function (b, a) {
      ...
      !a && c.floating
        ...
        : (c.floating && (c.placeholder.remove(), c.floating.children().detach(), c.floating.remove()),
          (c.floating = d(e.table().node().cloneNode(!1)).removeAttr('id').append(f).appendTo('body')),
