      ...
      return e
        ? (this.showLoading(),
          ...
          'function' == typeof this.options.params
            ...
            : ((this.options.params = a.fn.editableutils.tryParseJson(this.options.params, !0)), a.extend(c, this.options.params)),
          ...
          : ((this.options[b] = c),
            'disabled' === b
              ? c
                ? this.disable()
                : this.enable()
              : ('value' === b && this.setValue(c), this.container && this.container.option(b, c), this.input.option && this.input.option(b, c), void 0));
      },
            ...
            if (a.isEmptyObject(i)) {
              ...
              if (1 === h.length) {
                ...
                'function' == typeof k.options.params
                  ...
                  : ((k.options.params = a.fn.editableutils.tryParseJson(k.options.params, !0)), a.extend(l, k.options.params)),
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        onSourceReady: function (b, c) {
          var d;
          if (
            (a.isFunction(this.options.source) ? ((d = this.options.source.call(this.options.scope)), (this.sourceData = null)) : (d = this.options.source),
        ...
        makeArray: function (b) {
          ...
          if (a.isArray(b)) {
            ...
            for (var h = 0; h < b.length; h++)
              (e = b[h]),
                'object' == typeof e ? ((c = 0), a.each(e, f), 1 === c ? g.push(d) : c > 1 && (e.children && (e.children = this.makeArray(e.children)), g.push(e))) : g.push({ value: e, text: e });
          } else
              ...
              for (var f = 0; f < d.length; f++)
                (e = {}),
                  d[f].children
                    ...
                    : ((e.value = d[f].value), d[f].disabled && (e.disabled = !0), c.append(a('<option>', e).text(d[f].text)));
            return c;
          };
    ...
    var b = function (b, c) {
      return (
        ...
        this.$element.is('input')
          ? ((this.options = a.extend({}, a.fn.combodate.defaults, c, this.$element.data())), this.init(), void 0)
        ...
        if (b) {
          ...
          d.isValid() &&
            ...
            a.each(f, function (a, b) {
              e['$' + a] &&
                ('minute' === a && e.options.minuteStep > 1 && e.options.roundTime && (b = c(e['$' + a], b)),
      ...
      a.extend(b.prototype, {
        ...
        parseDate: function (a, b) {
          var c,
            d = null;
          return (
            a && ((d = this.dpg.parseDate(a, b, this.options.datepicker.language)), 'string' == typeof a && ((c = this.dpg.formatDate(d, b, this.options.datepicker.language)), a !== c && (d = null))),
            d
          );
        }
      }),
