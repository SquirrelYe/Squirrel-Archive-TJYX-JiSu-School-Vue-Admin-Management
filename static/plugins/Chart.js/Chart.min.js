                    ...
                    s.each(
                      ...
                      function (t) {
                        l.push(t.x),
                          ...
                          u.push({ fill: t._saved.fillColor || t.fillColor, stroke: t._saved.strokeColor || t.strokeColor });
                      },
                      this
                    ),
                    (o = m(r)),
            ...
            function (t) {
              ...
              e.each(
                ...
                this.options.datasetFill &&
                  h.length > 0 &&
                  (s.lineTo(h[h.length - 1].x, this.scale.endPoint), s.lineTo(h[0].x, this.scale.endPoint), (s.fillStyle = t.fillColor), s.closePath(), s.fill()),
                e.each(h, function (t) {
                  t.draw();
                });
            },
