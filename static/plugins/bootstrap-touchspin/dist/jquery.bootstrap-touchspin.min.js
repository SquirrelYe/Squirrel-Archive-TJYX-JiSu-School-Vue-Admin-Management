    ...
    return this.each(function () {
      ...
      function n(b) {
        ...
        e.hasClass('input-group-btn')
          ? ((c = '<button class="' + B.buttondown_class + ' bootstrap-touchspin-down" type="button">-</button>'), e.append(c))
          : ((c = '<span class="input-group-btn"><button class="' + B.buttondown_class + ' bootstrap-touchspin-down" type="button">-</button></span>'), a(c).insertBefore(J)),
          f.hasClass('input-group-btn')
            ? ((d = '<button class="' + B.buttonup_class + ' bootstrap-touchspin-up" type="button">+</button>'), f.prepend(d))
            : ((d = '<span class="input-group-btn"><button class="' + B.buttonup_class + ' bootstrap-touchspin-up" type="button">+</button></span>'), a(d).insertAfter(J)),
          a(g).insertBefore(J),
          a(h).insertAfter(J),
          (C = b);
      }
